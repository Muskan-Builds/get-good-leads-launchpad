  ...
  head: () => ({
    meta: [
      ...
      { title: "Get Good Leads — More Leads. Better Business." },
      {
        name: "description",
        content:
          "Get Good Leads is a performance marketing agency generating qualified, sales-ready leads through paid ads, SEO, funnels and CRO.",
      },
      { name: "author", content: "Get Good Leads" },
      { property: "og:site_name", content: "Get Good Leads" },
